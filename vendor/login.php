...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result['success']) {
        ...
        if ($result['user']['role'] === 'vendor' && $result['user']['vendor_id']) {
            $_SESSION['vendor_code'] = $result['user']['vendor_id'];
            header('Location: index.php');
            exit;
        } else {
...
<head>
    ...
    <title>Vendor Login - Licensify</title>
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <div class="login-footer">
                <p>Don't have an account? <a href="register.php" style="font-weight: 600;">Register with token →</a></p>
